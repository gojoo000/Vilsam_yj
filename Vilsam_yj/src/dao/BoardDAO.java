...
public class BoardDAO {
	...
	private static BoardDAO boardDAO; //외부클래스에서 dao변수에 직접 접근할 수 없도록 제한자 걸기

	private BoardDAO() {

	} //외부클래스에서 생성자를 사용해서 객체를 새로 생성할 수 없도록 제한자 걸기

	//싱글톤패턴으로 BoardDAO 객체를 생성해서 리턴해주는 메소드 정의
	...
	//BoardDAO 객체에 Connection 객체를 주입하는 메소드 정의
	...
	public int selectListCount() {
		...
		try {
			...
			pstmt=con.prepareStatement("SELECT count(*) FROM BOARD"); //전체 글 갯수 구하기
